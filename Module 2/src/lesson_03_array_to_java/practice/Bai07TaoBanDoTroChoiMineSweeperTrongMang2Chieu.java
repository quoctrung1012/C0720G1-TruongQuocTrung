...
////
////        Nội dung
////        Giả sử bạn tham gia lập trình trò chơi Mine Sweeper, một bộ phận khác đã giúp bạn tạo ra một ma trận với một số
////        vị trí được đánh dấu là có mìn, bạn sẽ bổ sung thông số về số lượng quả mìn xung quanh một ô vào ma trận đó.
////
...
////
////        Bước 1:tạo báo cáo từ một bản đồ 1 x1
////
////        Tạo một ma trận đầu vào với kích thước 1 x1 và có một vị trí được đánh dấu là có mìn, viết mã để in ra báo cáo
...
////
////        System.out.print("*");
////        Bước 2:tạo báo cáo từ một bản đồ 1 x2
////
////        Sửa mã để bản đồ đầu vào có 1 dòng và 2 cột, với một vị trí được đánh dấu là có mìn, sử dụng vòng lặp để in ra
////        báo cáo trong trường hợp này, trong vòng lặp, để dễ hiểu, sử dụng biến đếm là x cho chỉ mục của cột, và
////        nếu cần, y cho chỉ mục của hàng, giống như trong khái niệm hệ tọa độ toán học.Như vậy, ô bất kỳ trên bản đồ sẽ
////        được truy xuất bằng tọa độ[ y][x].
////
//        String[][] map = {
//                {"*", "."}
//        };
...
////
////        Biểu thức map[0].length và map[ 0][x]là khó đọc(không thể ngay lập tức hiểu).Ta đặt tên cho giá trị của
////        những biểu thức này
////
//        String[][] map = {
//                {"*", "."}
...
//        }
////        Bước 4:tái cấu trúc:
////        đoạn mã làm hai việc một lúc
////
////        Vòng lặp for ở đoạn mã trên đang làm hai việc cùng một lúc:
////        vừa kiểm tra các ô láng giềng vừa in kết quả ra màn hình.Đây là một nợ kỹ thuật có thể cản trở việc phát
////        triển ứng dụng này ở những bước sau.Để khử nợ kỹ thuật này, ta đưa việc “in kết quả ra màn hình”vào đoạn mã khác:
////
//        String[][] map = {
//                {"*", "."}
//        };
...
////
////        Với một ô bất kỳ, ta đếm trong các ô láng giềng của nó (ở đây mới có hai trường hợp là bên trái và bên phải)có ô
////        nào đang “ôm bom”hay không.
////
//        String[][] map = {
//                {"*", ".", "*", ".", "."}
//        };
...
////
////        Bước trước đã sản sinh ra mã lặp, một cách để khử chúng là liệt kê danh sách các láng giềng vào một mảng, sau
////        đó chạy vòng lặp để kiểm tra từng láng giềng một.
////
//                String[][] map = {
//                {"*", ".", "*", ".", "."}
//        };
...
////        Chạy thử để kiểm tra kết quả.
////
////                Bạn có thể thấy, nhờ liên tục tái cấu trúc, ta chỉ cần sửa rất ít mã ở bước này.Bạn có thể thêm mã để
////        tạo mảng đầu vào từ nhập liệu của người dùng.Bạn có thể tham khảo mã hoàn chỉnh ở đây.
    }
}
